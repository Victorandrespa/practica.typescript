...
//Funcion mayor Menor---------------------
function mayormenor(v1: number, v2: number, v3: number): string {
...
//Funcion Potencia---------------------
function potencia(exp: number, ba: number): string {
  let resultado = ba ** exp;

  return "Resultado: " + resultado;
};
//Funcion Inversa---------------------
function inversa(txt: string): string {
  let inverso: string[] = [];
...
//Funcion factorial---------------------
function factorial(fact: number): number {
  let resultado = 1;
...
//Funcion perfecto---------------------
function perfecto(num1: number): string {
  let suma = 0;
...
//Funcion primo---------------------
function primo(num1: number): string {
...
//Funcion vocales---------------------
function vocales(txt1: string): string {

  let vocales: string[] = [];
  let contador = 0;
  let filtro: string[] = ["a", "e", "i", "o", "u"];
...
if (btn_calcularPromedio) {
  btn_calcularPromedio.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_promedio_valor1") as HTMLInputElement;
    let input2 = document.getElementById("input_promedio_valor2") as HTMLInputElement;
    let input3 = document.getElementById("input_promedio_valor3") as HTMLInputElement;
...
if (btn_calcularTriangulo) {
  btn_calcularTriangulo.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_triangulo_valor1") as HTMLInputElement;
    let input2 = document.getElementById("input_triangulo_valor2") as HTMLInputElement;
...
if (btn_parimpar) {
  btn_parimpar.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_parimpar") as HTMLInputElement;
...
if (btn_mayormenor) {
  btn_mayormenor.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_mayormenor_valor1") as HTMLInputElement;
    let input2 = document.getElementById("input_mayormenor_valor2") as HTMLInputElement;
    let input3 = document.getElementById("input_mayormenor_valor3") as HTMLInputElement;
...
if (btn_potencia) {
  btn_potencia.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_potencia_valor1") as HTMLInputElement;
    let input2 = document.getElementById("input_potencia_valor2") as HTMLInputElement;
...
if (btn_inversa) {
  btn_inversa.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_inversa") as HTMLInputElement;
...
if (btn_factorial) {
  btn_factorial.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_factorial") as HTMLInputElement;
...
if (btn_perfecto) {
  btn_perfecto.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_perfecto") as HTMLInputElement;
...
if (btn_primo) {
  btn_primo.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_primo") as HTMLInputElement;
...
if (btn_vocales) {
  btn_vocales.addEventListener("click", () => {
    //alert("Funciona!")
    let input1 = document.getElementById("input_vocales") as HTMLInputElement;
